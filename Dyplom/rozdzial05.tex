...
\begin{itemize}
    \item \textbf{Postgres}:
    \begin{itemize}
        \item Obraz: \texttt{503561436372.dkr.ecr.eu-north-1.amazonaws.com/bachelor/deployment:postgres\_custom}
    ...
    \begin{itemize}
        \item Obraz: \texttt{503561436372.dkr.ecr.eu-north-1.amazonaws.com/bachelor/deployment:backend\_image\_latest}
    ...
    \begin{itemize}
        \item Obraz: \texttt{503561436372.dkr.ecr.eu-north-1.amazonaws.com/bachelor/deployment:solana\_scripts\_image\_latest}
        \item Port: \texttt{3001}
        \item Polecenie startowe: \texttt{npm start}
    \end{itemize}
    \item \textbf{Model Server}:
    \begin{itemize}
        \item Obraz: \texttt{503561436372.dkr.ecr.eu-north-1.amazonaws.com/bachelor/deployment:model\_server\_image\_latest}
        \item Port: \texttt{5000}
    \end{itemize}
    \item \textbf{Frontend App}:
    \begin{itemize}
        \item Obraz: \texttt{503561436372.dkr.ecr.eu-north-1.amazonaws.com/bachelor/deployment:frontend\_image\_latest}
